...
public class WorkspaceServiceImpl implements WorkspaceService {
     ...
     * @return
     */
    public BusinessDataVO getBusinessData(LocalDateTime startTime, LocalDateTime endTime) {
        /**
         * 营业额：当日已完成订单的总金额
         * 有效订单：当日已完成订单的数量
         * 订单完成率：有效订单数 / 总订单数
        ...
        //查询总订单数
        Integer totalOrderCount = reportMapper.countOrderByMap(map);
    ...
    public OrderOverViewVO getOrderOverView() {
        Map map = new HashMap();
        map.put("startTime", LocalDateTime.now().with(LocalTime.MIN));
